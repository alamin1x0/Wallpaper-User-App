package com.developeralamin.loveadmindashaboar.ui.finalWallpaper
...
import com.developeralamin.loveadmindashaboar.databinding.ActivityFinalWallpaperBinding
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                contentValues.put(
                    ...
                    Environment.DIRECTORY_PICTURES + File.separator + "/Pictures"
//                            + "/Pictures/Amoled Wallpaper"
                )
            }
            val imgeuri =
                resolver.insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, contentValues)
            data = resolver.openOutputStream(Objects.requireNonNull(imgeuri)!!)!!
            image?.compress(Bitmap.CompressFormat.JPEG, 100, data)
            Objects.requireNonNull<OutputStream?>(data)
            Toast.makeText(this, "Image Save Successful", Toast.LENGTH_SHORT).show()
        } catch (e: Exception) {
